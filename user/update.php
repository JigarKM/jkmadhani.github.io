						...
						<form action="" method="post" class="form-group form-container" >
							...
							<div class="form-group">
								<label for="city">City</label>
									...
									<option value=""> </option><optgroup title="TEXAS" label="&raquo; TEXAS"></optgroup><option value="Abernathy" >Abernathy</option><option value="addison" >Addison</option><option value="Austin" >Austin</option><option value="Baytown" >Baytown</option><option value="Beaumont" >Beaumont</option><option value="Dallas" >Dallas</option><option value="Longview" >Longview</option></select>
							</div><!--city end-->
