					...
					<div class="panel panel-default" style="padding: 20px;">
						<div class="panel-body">
								...
								<div class="alert alert-danger alert-dismissable" style="font-size: 18px; display: none;">
    								...
    								<strong>Warning!</strong> Are you sure you want a save the life if you press yes, then you will not be able to show up before 3 months.
							...
							<div class="heading text-center">
								<h3>Welcome </h3> <h1 <?php if (isset($_SESSION['name'])) echo $_SESSION['name']; {
